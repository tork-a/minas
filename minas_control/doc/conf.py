...
# The rST default role (used for this markup: `text`) to use for all documents.
#default_role = None
...
latex_documents = [
  ('index', 'minas_control.tex', ur'minas\_control',
   ur'Tokyo Opensource Robotics Kyokai Association', 'manual'),
]
